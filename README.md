...
get the app created:
    ...
    $ heroku apps:create faltan
    Creating faltan... done, stack is cedar
    http://faltan.herokuapp.com/ | git@heroku.com:faltan.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://faltan.herokuapp.com deployed to Heroku

    To git@heroku.com:faltan.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://faltan.herokuap.com
    ["Hello" :from Heroku]
